...
class ProfileController extends Controller
{
    ...
    public function update_name(Request $request)
    {
        ...
        return redirect(route('user.profile.index'))->with('success', 'Updated name.');
    }
    ...
    public function update_email(Request $request)
    {
        ...
        return redirect(route('user.profile.index'))->with('success', 'Updated email.');
    }
    ...
    public function update_institution(Request $request)
    {
        ...
        return redirect(route('user.profile.index'))->with('success', 'Updated institution.');
    }
    ...
    public function update_password(Request $request)
    {
        ...
        return redirect(route('user.profile.index'))->with('success', 'Updated password.');
    }
    ...
    public function destroy($id)
    {
        ...
        if ($deleted) {
            return redirect(route('user.sign-in.index'))->with('success', 'User account deleted successfully.');
        } else {
            Auth::login($user);
