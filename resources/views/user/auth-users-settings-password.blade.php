                    ...
                    <form>
                        ...
                        <div class="user-input flex flex-col gap-y-4 mx-12 my-10">
                            <div class="flex flex-row gap-x-24">
                                ...
                                <x-input id="password" class="block mt-1 input-settings" style="margin-left:1.9rem;"
                                        type="password"
                                        name="password"
                            ...
                            <div class="flex flex-row gap-x-24">
                                ...
                                <x-input id="password" class="block mt-1 input-settings" style="margin-left:1.5rem;"
                                        type="password"
                                        name="password"
                                        required autocomplete="current-password" />
                            </div>
                            <div class="flex flex-row gap-x-24">
                                ...
                                <x-input id="password" class="block mt-1 input-settings"
                                        type="password"
                                        name="password"
                                        required autocomplete="current-password" />
                            </div>
