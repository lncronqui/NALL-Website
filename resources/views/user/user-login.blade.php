...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-white">
        <header class="sticky top-0 z-50 text-white py-6" style="background-color:#2E052D;">
                <div class="flex items-center justify-between mx-auto">
                    ...
                    <div class="sign-margin space-x-5">
                        <button class="btn2" style="background-color: #FF29FB;"><a class="no-underline" href="/user-login">Sign In</a></button>
        ...
        <div class="grid lg:grid-cols-2 md:grid-cols-2">
                    <div class="text-left">
                        <img class="user-signup" src="/img/user-login.png" alt=""></img>
                    </div>
                
                    <div class="text-left">
                        <div class="margin-signin text-justify text-lg">
                            ...
                            <div class="text-center">
                                ...
                                <a class="font-bold text-md" href="/user-signup" style="color:#863084;">Create New Account</a>
                                <div class="text-sm font-normal pt-20 pb-6">Having trouble?<a class="font-bold text-sm" style="color:#863084;" href="/contact-us"> Contact Us</a></div>
                            </div>
                        </div>
                    </div>
                </div>
