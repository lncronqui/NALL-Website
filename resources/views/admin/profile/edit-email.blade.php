                ...
                <form method="POST" action="{{ route('admin.profile.update.email') }}">
                    ...
                    <div class="user-input flex flex-col gap-y-4 mx-12 my-10">
                        <div class="flex flex-row gap-x-24">
                            ...
                            <x-input id="email" class="block mt-1 w-2/4" style="margin-left:1.9rem;" type="email"
                                name="email" required autocomplete="current-email" />
                        </div>
                        <div class="flex flex-row gap-x-24">
                            <x-label for="email" :value="__('New Email')" class="font-normal mt-3"
                                style="color:#383838; font-size: 1rem;" />
                            <x-input id="email" class="block mt-1 w-2/4" style="margin-left:1.5rem;" type="email"
                                name="newEmail" required autocomplete="current-email" />
                        </div>
                        <div class="flex flex-row gap-x-24">
                            <x-label for="email" :value="__('Confirm Email')" class="font-normal mt-4"
                                style="color:#383838; font-size: 1rem;" />
                            <x-input id="email" class="block mt-1 w-2/4" type="email" name="newEmail_confirmation"
