                        ...
                        <div class="border-b-2 border-gray-300">
                            <div class="ml-16 mr-16">
                                <form method="get" id="v-article-form">
                                    <div class="flex mb-5">
                                        <label class="block text-gray-700 text-lg font-semibold" for="video-title"
                                            style="color:#2E052D;">
                                            Title:
                                        </label>
                                        <input
                                        ...
                                        <label class="block text-gray-700 text-lg font-semibold ml-5" for="video-acc"
                                            style="color:#2E052D;">
                                            Access Type:
                                        </label>
                                        <select name="format"
                                    ...
                                    <div id="fields">
                                        <div class="flex mb-5">
                                            ...
                                            <input
                                                class="shadow appearance-none border rounded w-full h-12 py-2 px-3 text-gray-700 bg-white bg-clip-padding
                                                    focus:outline-none focus:shadow-outline"
                                                style="margin-left: 38px;" id="aud-author" type="text" required>
                                            ...
                                            <button class="add-fields fa fa-plus-circle ml-2"
                                    ...
                                    <div class="flex mb-5">
                                        <label class="block text-gray-700 text-lg font-semibold" for="video-abstract"
                                            style="color:#2E052D;">
                                            Abstract:
                                        </label>
                                        <textarea
                                    ...
                                    <div id="field">
                                        <div class="flex mb-5">
                                            ...
                                            <input
                                                class="shadow appearance-none border rounded w-full h-12 py-2 px-3 text-gray-700 bg-white bg-clip-padding
                                                    focus:outline-none focus:shadow-outline"
                                                style="margin-left: 28px;" id="aud-subj" type="text"
                                                required>
                                            <button class="add-field fa fa-plus-circle ml-2"
                                                style="font-size:48px; color: gray;">
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex mb-5">
                                        <label class="block text-gray-700 text-lg font-semibold" for="video-url"
                                            style="color:#2E052D;">
                                            URL:
                                        </label>
                                        <input
                                    ...
                                    <div class="flex mb-5">
                                        <label class="block text-gray-700 text-lg font-semibold" for="video-inst"
                                            style="color:#2E052D;">
                                            Institution:
                                        </label>
                                        <select name="format"
                                        ...
                                        <label class="block text-gray-700 text-lg font-semibold ml-5" for="video-date"
                                            style="color:#2E052D;">
                                            Date Published:
                                        </label>
                                        <input
                                            class="shadow appearance-none border rounded ml-5 w-full h-12 py-2 px-3 text-gray-700 bg-white bg-clip-padding
                                                focus:outline-none focus:shadow-outline"
                                            style="margin-left: 27px;" id="video-date" type="text"
                                            required></input>
