            ...
            <div class="text-left col-span-8">
                <div class="ml-10 mt-5 mr-8">
                    ...
                    <div class="flex flex-row gap-x-6">
                        ...
                        <button class="btn" style="height: 3.2rem; width: 11.7rem; border-radius: 10px;"><a
                                class="no-underline" href="{{ route('admin.repository.create') }}">+Add
                                Article</a></button>
                    </div>
                    ...
                    <div class="flex flex-row gap-x-2 mt-6 ">
                        ...
                        <div class="select ml-2">
                            <select name="format" id="editFormat" onChange="siteRedirect()">
                                <option selected disabled value="{{ route('admin.repository.view.elec') }}">Electronic
                                    Resource</option>
