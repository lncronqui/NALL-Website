    ...
    <body>
        <div class="grid-container grid lg:grid-cols-10 md:grid-cols-10 divide-x-4 divide-solid divide-gray-300 pt-10 pb-20 px-10">
            ...
            <form method="get">
                ...
                <a style="font-size:24px" class="fa" style="color: #C4C4C4;" href="/institution-list">&#xf060;</a>
                    ...
                    <div class="border-b-2 border-gray-300 mb-5">
                            <input class="shadow appearance-none border rounded w-full h-12 mt-4 py-2 px-3 text-gray-700 bg-white bg-clip-padding 
                                                focus:outline-none focus:shadow-outline" id="add-inst" type="text" required></input>
                    </div>
                </div>
