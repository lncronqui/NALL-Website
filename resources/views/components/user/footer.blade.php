        ...
        <div class="grid pt-20 pb-20 lg:grid-cols-4 md:grid-cols-4">
            ...
            <div class="text-left mb-6">
                ...
                <ul class="list-none mb-0">
                    ...
                    @if (Auth::check())
                        <li>
                            <a href="{{ route('user.profile.index') }}" class="hovertext text-gray-200">Settings &
                                Privacy</a>
                        </li>
                    @else
                        <li>
                            <a href="{{ route('user.sign-in.index') }}" class="hovertext text-gray-200">Sign In</a>
                        </li>
                        <li>
                            <a href="{{ route('user.sign-up.index') }}" class="hovertext text-gray-200">Sign Up</a>
                        </li>
                    @endif
