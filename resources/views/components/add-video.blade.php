        ...
        <div class="border-b-2 border-gray-300">
            <div class="ml-16 mr-16">
                ...
                <!--need to make on-click add new field-->
                    ...
                    <div class="flex mb-5">
                            <label class="block text-gray-700 text-lg font-semibold" for="video-journ" style="color:#2E052D;">
                                Journal Titles:
                            </label> 
                            <input class="shadow appearance-none border rounded w-full h-12 py-2 px-3 text-gray-700 bg-white bg-clip-padding 
                                                focus:outline-none focus:shadow-outline" style="margin-left: -1px;" id="video-journ" type="text" required></input>
                    </div>
